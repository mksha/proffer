...
var rootCmd = &cobra.Command{
	...
	Long: `Proffer is a command-line tool to distribute cloud images in between multiple regions and 
with multiple environments. This tool only needs a yml configuration file with name proffer that 
defines the image distribution operations and actions.`,
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".proffer" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".proffer")
	}
